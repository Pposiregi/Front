...
SlimPet은 **사용자의 건강 데이터를 펫과 연동**하여 즐겁게 관리할 수 있는 헬스케어
앱입니다.  
...
- Health Connect 연동을 위해 **Android 8.0 (API 26) 이상** 단말이 필수입니다. (Health Connect는 Android 14 이상에서는 OS에 기본 탑재되며, Android 13 이하에서는 Play 스토어에서 설치/업데이트가 필요합니다.)
