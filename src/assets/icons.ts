...
import IconRunActive from './images/Icon_colored/fp_run.png';
import IconRunInactive from './images/Icon_uncolored/fp_run.png';
...
> = {
  Activity: {
    focused: IconRunActive,
    unfocused: IconRunInactive,
    style: {
      width: 48,
      height: 48,
    },
